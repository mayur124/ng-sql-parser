(function(root) {
  ...
  Lexer = (function() {
    var BOOLEAN, DBLSTRING, LITERAL, CUBIXLITERAL, MATH, MATH_MULTI, NUMBER, SEPARATOR, SQL_CONDITIONALS, SQL_FUNCTIONS, SQL_KEYWORDS, SQL_OPERATORS, SQL_SORT_ORDERS, STAR, STRING, WHITESPACE;
    ...
    Lexer.prototype.cubixToken = function () {
      return this.tokenizeFromRegex('CUBIXLITERAL', CUBIXLITERAL, 1 , 0);
    };
